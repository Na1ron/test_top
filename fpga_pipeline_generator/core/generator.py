...
from fpga_pipeline_generator.core.config_loader import ConfigLoader, DefaultConfig, StageConfig
...
class FPGAPipelineGenerator:
    ...
    def prepare_job_context(
        ...
        stage_config: Optional[StageConfig] = self.config_loader.get_stage_config(stage, self.config)
